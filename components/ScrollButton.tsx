...
export default function ScrollButton({ targetId }: { targetId: string }) {
  ...
  return (
    ...
    >
      <svg className="w-6 h-6 animate-bounce text-[var(--theme-gold)] group-hover:text-[var(--theme-gold)] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
