...
export default function AboutPage({ params }: AboutPageProps) {
  ...
  const translations: Record<string, any> = {
    en: {
      title: 'About Traveloo',
      subtitle: 'Discover the magic of Egypt with our expert-curated tours',
      storyText: 'Traveloo is a premier Egypt tours booking platform, dedicated to providing unforgettable experiences across the ancient land of Egypt.',
      storyTitle: 'Our Story',
      storyDesc: 'Founded with a passion for Egyptian history and culture, Traveloo has been helping travelers discover the magic of Egypt for over a decade.',
      whyChooseTitle: 'Why Choose Us',
      reasons: [
        'Expert local guides with deep knowledge of Egyptian history',
      ...
      teamTitle: 'Our Team',
      teamText: 'Our team consists of passionate Egyptologists, experienced tour guides, and dedicated travel professionals all united by our love for this incredible country.',
      ctaButton: 'Explore Our Tours',
    },
    ru: {
      title: 'О Traveloo',
      subtitle: 'Откройте магию Египта с нашими экспертными турами',
      storyText: 'Traveloo — ведущая платформа для бронирования туров по Египту.',
      storyTitle: 'Наша история',
      storyDesc: 'Основана с любовью к истории и культуре Египта.',
      whyChooseTitle: 'Почему выбирают нас',
      reasons: [
        'Экскурсоводы с глубокими знаниями истории Египта',
      ...
      teamText: 'Наша команда состоит из увлечённых египтологов и опытных гидов.',
