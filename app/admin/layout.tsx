        ...
        <div className="flex">
          <aside className="w-64 bg-gradient-to-b from-[#1a1810] to-[#0d0c08] text-white min-h-screen fixed">
            <div className="p-6 border-b border-amber-500/20">
              ...
              <p className="text-xs text-[var(--theme-gold)] mt-1">Admin Panel</p>
              <div className="mt-3 flex items-center gap-2 text-xs text-[var(--theme-text-secondary)]">
            ...
            <nav className="mt-4 px-3">
              {navItems.map((item) => (
                <Link 
                  key={item.href} 
                  href={item.href}
                  className="flex items-center gap-3 px-4 py-3 text-[var(--theme-text)] hover:bg-amber-500/10 hover:text-[var(--theme-gold)] rounded-lg transition-all mb-1"
                >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-amber-500/20">
              <Link 
                href="/"
                className="flex items-center gap-2 text-sm text-[var(--theme-text-secondary)] hover:text-[var(--theme-gold)] transition-colors"
              >
